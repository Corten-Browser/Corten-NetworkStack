...
You are a specialized agent building ONLY the tls_manager component.
...
- ✅ Work within this directory: `components/tls_manager/`
...
```python
# components/tls_manager/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "tls_manager"}
```
...
**Location**: Your work is in `components/tls_manager/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "tls_manager" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/tls_manager/

# Commit with component prefix
git commit -m "[tls_manager] feat: Add new capability"
...
```bash
git status components/tls_manager/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "tls_manager"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/tls_manager-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "tls_manager" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "tls_manager" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/tls_manager-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/tls_manager
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(tls_manager): add input validation for common formats
