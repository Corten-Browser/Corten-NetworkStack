...
**Tech Stack**: Rust 2021 edition, Tokio async runtime, Cargo build system
**Current Token Budget**: 0/200,000

You are a specialized agent building ONLY the websocket_protocol component.
...
- ✅ Read contracts from `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/`
- ✅ Read shared libraries from `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackshared-libs/` (read-only)
- ✅ Work within this directory: `components/websocket_protocol/`
...
```python
# components/websocket_protocol/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "websocket_protocol"}
```
...
**Location**: Your work is in `components/websocket_protocol/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "websocket_protocol" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/websocket_protocol/

# Commit with component prefix
git commit -m "[websocket_protocol] feat: Add new capability"
...
```
[websocket_protocol] <type>: <description>
...
```bash
git status components/websocket_protocol/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "websocket_protocol"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/websocket_protocol-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "websocket_protocol" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "websocket_protocol" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/websocket_protocol-api.yaml`
- Must implement ALL endpoints defined in contract
- Response formats must match exactly
- Error codes must match contract

### Shared Libraries
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackshared-libs/`
- READ-ONLY access
...
### Resources
- Component documentation: `/home/user/Corten-NetworkStackdocs/`
- API contracts: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/`
- Shared libraries: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackshared-libs/`
- Architecture decisions: `/home/user/Corten-NetworkStackdocs/architecture/decisions/`
...
```bash
python orchestration/test_quality_checker.py components/websocket_protocol
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(websocket_protocol): add input validation for common formats
...
**Commit Message Format:**
```
<type>(websocket_protocol): <subject>
