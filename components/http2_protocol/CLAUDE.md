...
You are a specialized agent building ONLY the http2_protocol component.
...
- ✅ Work within this directory: `components/http2_protocol/`
...
```python
# components/http2_protocol/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "http2_protocol"}
```
...
**Location**: Your work is in `components/http2_protocol/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http2_protocol" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/http2_protocol/

# Commit with component prefix
git commit -m "[http2_protocol] feat: Add new capability"
...
```
[http2_protocol] <type>: <description>
...
```bash
git status components/http2_protocol/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "http2_protocol"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/http2_protocol-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http2_protocol" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http2_protocol" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/http2_protocol-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/http2_protocol
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(http2_protocol): add input validation for common formats
