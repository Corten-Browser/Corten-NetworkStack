...
You are a specialized agent building ONLY the http1_protocol component.
...
- ✅ Work within this directory: `components/http1_protocol/`
...
```python
# components/http1_protocol/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "http1_protocol"}
```
...
**Location**: Your work is in `components/http1_protocol/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http1_protocol" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/http1_protocol/

# Commit with component prefix
git commit -m "[http1_protocol] feat: Add new capability"
...
```
[http1_protocol] <type>: <description>
...
```bash
git status components/http1_protocol/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "http1_protocol"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/http1_protocol-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http1_protocol" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http1_protocol" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/http1_protocol-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/http1_protocol
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(http1_protocol): add input validation for common formats
