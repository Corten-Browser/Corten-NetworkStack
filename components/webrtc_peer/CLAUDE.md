...
You are a specialized agent building ONLY the webrtc_peer component.
...
- ✅ Work within this directory: `components/webrtc_peer/`
...
```python
# components/webrtc_peer/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "webrtc_peer"}
```
...
**Location**: Your work is in `components/webrtc_peer/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "webrtc_peer" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/webrtc_peer/

# Commit with component prefix
git commit -m "[webrtc_peer] feat: Add new capability"
...
```bash
git status components/webrtc_peer/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "webrtc_peer"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/webrtc_peer-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "webrtc_peer" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "webrtc_peer" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/webrtc_peer-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/webrtc_peer
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(webrtc_peer): add input validation for common formats
