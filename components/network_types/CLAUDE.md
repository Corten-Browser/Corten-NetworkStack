...
You are a specialized agent building ONLY the network_types component.
...
### Purpose
Core types: NetworkRequest, NetworkResponse, HTTP enums, request/response structures
...
- ✅ Work within this directory: `components/network_types/`
...
```python
# components/network_types/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "network_types"}
```
...
**Location**: Your work is in `components/network_types/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_types" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/network_types/

# Commit with component prefix
git commit -m "[network_types] feat: Add new capability"
...
```
[network_types] <type>: <description>
...
```bash
git status components/network_types/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "network_types"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/network_types-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_types" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_types" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/network_types-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/network_types
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(network_types): add input validation for common formats
