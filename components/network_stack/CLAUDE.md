...
You are a specialized agent building ONLY the network_stack component.
...
- ✅ Work within this directory: `components/network_stack/`
...
```python
# components/network_stack/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "network_stack"}
```
...
**Location**: Your work is in `components/network_stack/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_stack" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/network_stack/

# Commit with component prefix
git commit -m "[network_stack] feat: Add new capability"
...
```
[network_stack] <type>: <description>
...
```bash
git status components/network_stack/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "network_stack"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/network_stack-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_stack" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_stack" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/network_stack-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/network_stack
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(network_stack): add input validation for common formats
