...
You are a specialized agent building ONLY the cookie_manager component.
...
- ✅ Work within this directory: `components/cookie_manager/`
...
```python
# components/cookie_manager/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "cookie_manager"}
```
...
**Location**: Your work is in `components/cookie_manager/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "cookie_manager" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/cookie_manager/

# Commit with component prefix
git commit -m "[cookie_manager] feat: Add new capability"
...
```
[cookie_manager] <type>: <description>
...
```bash
git status components/cookie_manager/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "cookie_manager"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/cookie_manager-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "cookie_manager" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "cookie_manager" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/cookie_manager-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/cookie_manager
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(cookie_manager): add input validation for common formats
