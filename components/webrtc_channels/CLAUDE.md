...
You are a specialized agent building ONLY the webrtc_channels component.
...
- ✅ Work within this directory: `components/webrtc_channels/`
...
```python
# components/webrtc_channels/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "webrtc_channels"}
```
...
**Location**: Your work is in `components/webrtc_channels/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "webrtc_channels" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/webrtc_channels/

# Commit with component prefix
git commit -m "[webrtc_channels] feat: Add new capability"
...
```
[webrtc_channels] <type>: <description>
...
```bash
git status components/webrtc_channels/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "webrtc_channels"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/webrtc_channels-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "webrtc_channels" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "webrtc_channels" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/webrtc_channels-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/webrtc_channels
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(webrtc_channels): add input validation for common formats
