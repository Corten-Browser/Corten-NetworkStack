...
You are a specialized agent building ONLY the http_cache component.
...
- ✅ Work within this directory: `components/http_cache/`
...
```python
# components/http_cache/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "http_cache"}
```
...
**Location**: Your work is in `components/http_cache/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http_cache" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/http_cache/

# Commit with component prefix
git commit -m "[http_cache] feat: Add new capability"
...
```bash
git status components/http_cache/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "http_cache"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/http_cache-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http_cache" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "http_cache" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/http_cache-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/http_cache
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(http_cache): add input validation for common formats
