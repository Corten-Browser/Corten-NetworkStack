...
You are a specialized agent building ONLY the network_errors component.
...
- ✅ Work within this directory: `components/network_errors/`
...
```python
# components/network_errors/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "network_errors"}
```
...
**Location**: Your work is in `components/network_errors/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_errors" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/network_errors/

# Commit with component prefix
git commit -m "[network_errors] feat: Add new capability"
...
```
[network_errors] <type>: <description>
...
```bash
git status components/network_errors/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "network_errors"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/network_errors-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_errors" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "network_errors" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/network_errors-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/network_errors
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(network_errors): add input validation for common formats
