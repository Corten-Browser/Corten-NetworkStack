...
You are a specialized agent building ONLY the dns_resolver component.
...
- ✅ Work within this directory: `components/dns_resolver/`
...
```python
# components/dns_resolver/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "dns_resolver"}
```
...
**Location**: Your work is in `components/dns_resolver/`
...
```bash
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "dns_resolver" "feat: Add new capability"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/dns_resolver/

# Commit with component prefix
git commit -m "[dns_resolver] feat: Add new capability"
...
```bash
git status components/dns_resolver/
# or
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_status.py "dns_resolver"
```
...
- [ ] Read API contract: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/dns_resolver-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "dns_resolver" "test/feat/refactor: [description]"`
...
python ./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackorchestration/git_retry.py "dns_resolver" "feat: implement user registration
...
### API Contract
- Location: `./home/user/Corten-NetworkStack./home/user/Corten-NetworkStackcontracts/dns_resolver-api.yaml`
...
```bash
python orchestration/test_quality_checker.py components/dns_resolver
```
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(dns_resolver): add input validation for common formats
